namespace LabBigSchool_CuDucHiep.Migrations
{
    ...
    public partial class AddAttendance1 : DbMigration
    {
        public override void Up()
        {
            ...
            DropColumn("dbo.Attendances", "AtttenId");
        }
        
        public override void Down()
        {
            AddColumn("dbo.Attendances", "AtttenId", c => c.String(nullable: false, maxLength: 128));
            DropForeignKey("dbo.Attendances", "AttendeeId", "dbo.AspNetUsers");
            DropIndex("dbo.Attendances", new[] { "AttendeeId" });
            DropPrimaryKey("dbo.Attendances");
            AlterColumn("dbo.Attendances", "AttendeeId", c => c.String(maxLength: 128));
            AddPrimaryKey("dbo.Attendances", new[] { "CourseId", "AtttenId" });
